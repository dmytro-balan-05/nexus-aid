        ...
        <div className="min-h-screen bg-gray-50">
            <section className="bg-black text-white py-20 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <h1 className="text-5xl font-black mb-4 tracking-tight">
                        NEXUS<span className="text-blue-400">AID</span>
                    </h1>
                    <p className="text-xl text-gray-300 mb-4 max-w-2xl mx-auto">
                        Єдина платформа для прозорих благодійних зборів з верифікацією волонтерів та системою досягнень
                    </p>
                    <p className="text-gray-500 mb-10 text-sm">
                        Збори структуровані, волонтери перевірені, кошти прозорі
                    </p>
                    <div className="flex gap-4 justify-center flex-wrap">
                        <Link href="/campaigns" className="bg-white text-black px-8 py-3 rounded-xl font-bold hover:bg-gray-100 transition">
                            Всі збори
                        </Link>
                        <QuickDonateButton />
                        <Link href="/register" className="border border-white text-white px-8 py-3 rounded-xl font-bold hover:bg-white hover:text-black transition">
                            Приєднатись
                        </Link>
                    </div>
                </div>
            ...
            <section className="py-10 bg-white border-b border-gray-100">
                <div className="max-w-4xl mx-auto px-4 grid grid-cols-3 gap-6 text-center">
                    <div>
                        <div className="text-3xl font-black text-gray-900">{stats.campaigns}</div>
                        <div className="text-sm text-gray-500 mt-1">активних зборів</div>
                    </div>
                    <div>
                        <div className="text-3xl font-black text-gray-900">{stats.donors}</div>
                        <div className="text-sm text-gray-500 mt-1">донорів</div>
                    </div>
                    <div>
                        <div className="text-3xl font-black text-gray-900">{stats.totalAmount.toLocaleString()} ₴</div>
                        <div className="text-sm text-gray-500 mt-1">зібрано всього</div>
                    </div>
                </div>
            </section>
                ...
                <section className="py-12 px-4">
                    <div className="max-w-5xl mx-auto">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-2xl font-extrabold text-gray-900">Термінові збори</h2>
                            <span className="text-sm text-gray-400">— потребують допомоги зараз</span>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {urgent.map(({ category, campaign }) => {
                                ...
                                return (
                                    <div key={campaign.id} className="bg-white rounded-2xl border border-blue-200 overflow-hidden shadow-sm">
                                        <div className="relative">
                                            <img
                                                src={campaign.images?.[0] || 'https://placehold.co/400x200/png?text=NexusAid'}
                                                alt={campaign.title}
            ...
            <section className="py-12 px-4 bg-white">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-extrabold text-gray-900 mb-8 text-center">Чому NexusAid?</h2>
